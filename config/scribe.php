...
return [
    ...
    'description' => 'Tài liệu mô tả các endpoint API của hệ thống.',
...
INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Lấy token qua `POST /api/v1/auth/login`, sau đó gửi header `Authorization: Bearer <token>`.',
    ],
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Cập nhật lần cuối: {date:d/m/Y}',
